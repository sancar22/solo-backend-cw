...
<br/>
`/client-side/allCourses` client view of all courses
...
<br/>
`/client-side/myCourses` client view courses a user is enrolled in + their progress
* GET
* Headers:`Authorization: bearer token`
* Response: **200**, courses

<br/>
`/enroll/free` enroll a client in a free course
...
<br/>
`/enroll/premium` enroll a user in a premium course
